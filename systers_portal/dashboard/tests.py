...
class DashboardTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.resource_type = ResourceType.objects.create(name='dummy_resource_type')
    ...
    def test_community_model(self):
        ...
        community_members = SysterUser.objects.filter(member_of_community=community)
    ...
    def test_CommunityPage_model(self):
        ...
        about_dummy_community = create_page('About',
                                            'page_template.html',
                                            'en-us')
        about_page_for_dummy_community = CommunityPage.objects.create(title='About',
        ...
        faq_page_for_dummy_community = CommunityPage.objects.create(title='FAQ',
        ...
        second_community = Community.objects.create(name='second_dummy_community',
                                                    community_admin=systeruser)
        about_second_dummy_community = create_page('About',
                                                   'page_template.html',
                                                   'en-us')
        about_page_for_second_dummy_community = CommunityPage.objects.create(title='About',
        ...
        self.assertEqual(about_page_for_second_dummy_community,
                         Page.objects.get(communitypage=about_page_for_second_dummy_community).communitypage)
        self.assertEqual(about_second_dummy_community,
                         Page.objects.get(communitypage=about_page_for_second_dummy_community))
